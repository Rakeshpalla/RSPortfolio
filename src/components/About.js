...
const About = () => {
  return (
    <section id="about" className="py-10 relative bg-gradient-to-br from-slate-800 via-slate-900 to-blue-900 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <h3 className="text-3xl font-bold text-white mb-6 text-center">Strategic Leadership Pillars</h3>
