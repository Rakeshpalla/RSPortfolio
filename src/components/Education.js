          ...
          <div className="p-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
              {education.map((item, index) => (
                <div key={index} className="bg-white rounded-2xl p-4 shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
