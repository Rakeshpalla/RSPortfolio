        ...
        >
          <div className="p-8">
            <div className="text-center mb-16">
              <h3 className="text-2xl font-bold text-slate-800 mb-6">Core Leadership Strengths</h3>
              <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Proven leadership capabilities that drive organizational success and create lasting impact
              </p>
            </div>
